...
const CardCarousel: React.FC = () => {
  ...
  return (
    <div className="my-8 relative container">
      <h1 className="text-center text-gray-400 text-3xl font-extrabold my-8">INFO PASLON</h1>
      <div className=" bg-gray-400 mx-4 sm:mx-8 md:mx-20 lg:mx-24 px-4 sm:px-8 md:px-10 lg:ps-24 py-8 sm:py-10 lg:py-12 flex flex-col sm:flex-row gap-4 sm:gap-4 my-3 rounded-md place-content-center transition-transform duration-300 ease-in-out transform">
