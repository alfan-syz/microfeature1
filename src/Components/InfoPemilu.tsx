...
const InfoPemilu: React.FC = () => {
  return (
    <div>
      <div className=" py-9">
        <h1 className="text-center text-3xl font-extrabold mb-10 text-gray-400 ">
          INFO PEMILU TERUPDATE
        </h1>
        <div className="flex item-center justify-center gap-20">
          <div>
            <h1 className="text-center font-bold text-xl mb-2 text-gray-400">Hasil :</h1>
            <img
          ...
          <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3">
                <div className="py-1 px-1 border-2 rounded-lg bg-red-800 border-white">
                  <p className="text-xs font-bold text-center text-white">
                    No <p>Paslon</p> <p className="text-lg -mt-1">1</p>
                  </p>
                </div>
                <div>
            ...
            <div className="bg-yellow-400 px-4 py-2 rounded-lg shadow-lg">
              <div className="flex items-center gap-3">
                <div className="py-1 px-1 border-2 rounded-lg bg-red-800 border-white">
                  <p className="text-xs font-bold text-center text-white">
                    No <p>Paslon</p> <p className="text-lg -mt-1">2</p>
                  </p>
                </div>
                <div>
                  <h1 className="text-lg font-bold text-red-800">
